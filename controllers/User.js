    ...
    .then((hash) => {
      ...
      user
        ...
        .then((newObj) => {
          ...
          signUpVerfication.signUpConfirmation(
            user.email,
            user.name,
            user.userName,
            req.body.password
        ...
        .catch((e) => {
          console.log(e);
          res.status(400).json({
            message: "Please fill all the field or user already exist",
          });
        });
    })
    .catch((e) => {
      res.status(400).json({
        message: "Please check your details or the user already exist",
      });
      console.log(e);
    });
};
