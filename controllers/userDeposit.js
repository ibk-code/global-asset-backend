    ...
    UserSignUp.findById(userId)
        .then(obj => {
            ...
            const mailOptions = {
                ...
                text: `Deposit process of $${req.body.amount} from user ${obj.name} with ${obj._id} with email address of ${obj.email} from wallet address of ${req.body.address}, with ${planStatus}`
            };
